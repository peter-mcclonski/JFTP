...
public class AppeCommand extends Command {
	public void execute(Session sess, String[] args) {
		...
		if(!FileManager.write(sess.getWorkingDirectory() + args[0], new byte[0], sess.getUser(), true)) {
		...
		FileManager.write(sess.getWorkingDirectory() + args[0], bytes, sess.getUser(), true);
