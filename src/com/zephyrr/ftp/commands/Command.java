...
public abstract class Command {
	...
	public String getCodeMsg(int code) {
		...
		case 221: return "221 Service closing control connection.  Logged out.";	
		case 225: return "225 Data connection open; no transfer in progress.";
		case 226: return "226 Closing data connection.  Requested file action successful.";
		case 227: return "227 Entering Passive Mode (h1,h2,h3,h4,p1,p2)";
		case 230: return "230 User logged in, proceed.";
		case 250: return "250 Requested file action okay, completed.";
		case 257: return "257 \"$PATHNAME\" created.";
		...
		case 450: return "450 Requested file action not taken.  File unavailable.";
		case 451: return "451 Requested action aborted: local error in processing.";
		case 452: return "452 Requested action not taken.  Insufficient storage space in system.";
		...
		case 550: return "550 Requested action not taken.  File unavailable.";
		case 551: return "551 Requested action aborted: page type unknown.";
		case 552: return "552 Requested file action aborted.  Exceeded storage allocation.";
		case 553: return "553 Requested action not taken.  File name not allowed.";
		}
		return "";
	}
